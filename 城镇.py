...
list_data1 = sheet.col_values(7)[1:]
list_data2 = sheet.col_values(8)[1:]
...
bar = (
    ...
    .set_global_opts(
        ...
        title_opts=opts.TitleOpts(title=rows[7])
    )
)
...
bar.overlap(line)
grid = Grid()
grid.add(bar, opts.GridOpts(pos_left="10%", pos_right="15%"), is_control_axis_index=True)
grid.render('城镇.html')
